...
case class ProvidesClass(
  ...
  require( internalName != null, "interalName cannot be null" )
  require( superName != null, "superName cannot be null" )
  require( interfaces forall { _ != null }, "interfaces cannot contain a null" )
